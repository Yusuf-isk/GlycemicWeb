...
export const userAndAdminLogin = (email: string, password: string) => {
  ...
  return conf.post("register/login", { email, password }, { params: params });
};
export const loginGlycemic = (creds) => {
  const params = {
    email: creds.username,
  };
  return axios.post("register/login", creds, { params: params });
};
...
export const userRegister = (
  ...
  return axios.post(
    process.env.REACT_APP_BASE_URL + "/register/adminRegister",
    params
  );
};

export const foodAdd = (body) => {
  const headers = autControl();

  return axios.post(process.env.REACT_APP_BASE_URL + "/foods/save", body, {
    headers: headers,
  });
};
...
export const adminWaitFoodList = () => {
  const headers = autControl();
  return axios.get(
    process.env.REACT_APP_BASE_URL + "/foods/adminWaitFoodList",
    {
      headers: headers,
    }
  );
